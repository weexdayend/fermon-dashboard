  ...
  const columns: ColumnDef<UserListProps>[] = [
    {
      ...
      cell: ({ row }) => {
        return (
          <div className="text-sm">{row.getValue("kode_kecamatan")}</div>
        )
      },
    },
    {
      ...
      cell: ({ row }) => (
        <div className="text-sm">{row.getValue("nama_kecamatan")}</div>
      ),
    },
    // {
    //   id: "actions",
        ...
        <div className="w-full">
          <div className="flex flex-row justify-between items-center py-4">
            <div className='flex flex-row gap-2 items-center'>
              <Input
                placeholder="Filter nama kecamatan..."
                value={(table.getColumn("nama_kecamatan")?.getFilterValue() as string) ?? ""}
                onChange={(event) =>
                  table.getColumn("nama_kecamatan")?.setFilterValue(event.target.value)
                }
                className="max-w-sm"
              />
            </div>
